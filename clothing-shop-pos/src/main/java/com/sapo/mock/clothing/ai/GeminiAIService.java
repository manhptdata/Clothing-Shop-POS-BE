...
public class GeminiAIService {
    ...
    private String callGeminiApi(String prompt) {
        ...
        try {
            ...
            throw new com.sapo.mock.clothing.exception.BadRequestException("Không thể lấy kết quả từ AI.");

        } catch (HttpClientErrorException e) {
            if (e.getStatusCode().value() == 429) {
                throw new com.sapo.mock.clothing.exception.BadRequestException(
                        "AI đã đạt giới hạn lượt gọi (Rate Limit). Vui lòng thử lại sau.");
            }
            throw new com.sapo.mock.clothing.exception.BadRequestException("Lỗi khi gọi AI: " + e.getMessage());
        } catch (HttpServerErrorException e) {
            if (e.getStatusCode().value() == 503) {
                throw new com.sapo.mock.clothing.exception.BadRequestException(
                        "Dịch vụ AI đang quá tải (503). Vui lòng thử lại sau.");
            }
            throw new com.sapo.mock.clothing.exception.BadRequestException("Lỗi server AI: " + e.getMessage());
        } catch (com.sapo.mock.clothing.exception.BadRequestException e) {
            throw e;
        } catch (Exception e) {
            e.printStackTrace();
            throw new com.sapo.mock.clothing.exception.BadRequestException(
                    "Lỗi hệ thống khi gọi AI: " + e.getMessage());
        }
    }
    ...
    public String analyzeInventory(String customPrompt, int days) {
        ...
        String sqlPrompt = "Bạn là một AI tạo câu lệnh SQL. Tôi có CSDL như sau:\n" +
                ...
                "LƯU Ý VỀ THỜI GIAN: Nếu người dùng không chỉ định rõ thời gian trong câu hỏi, hãy mặc định lấy dữ liệu của các đơn hàng trong "
                + days + " ngày gần nhất (tính từ hôm nay). " +
        ...
        String analysisPrompt = "Bạn là AI chuyên phân tích số liệu.\n" +
                ...
                "THÔNG TIN HỆ THỐNG: Mặc định dữ liệu đang được lọc trong khoảng thời gian " + days
                + " ngày gần nhất.\n" +
